...
public class UploadFile
{
  ...
  throws Exception
{
	  String paramString=this.m_filename;
	  paramString=FileSave.Filepath(paramString);
	  saveAs(paramString, 0);
	  return paramString;
}
  
  public String saveAsEncode()
  throws Exception
{
	  String paramString=this.m_filename;
	  paramString=FileSave.Filepathencode(paramString);
	  saveAs(paramString, 0);
	  return paramString;
}
  public String saveAsEncode(String rootpath)
  throws Exception
{
	  String paramString=this.m_filename;
	  paramString=FileSave.Filepathencode(rootpath,paramString);
	   saveAs(paramString, 0);
	  return paramString;
}
  public String saveAsDecode()
  throws Exception
{
	  String paramString=this.m_filename;
	  paramString=FileSave.Filepathdecode(paramString);
	  saveAs(paramString, 0);
	  return paramString;
}
  public String saveAsDecode(String rootpath)
  throws Exception
{
	  String paramString=this.m_filename;
	  paramString=FileSave.Filepathdecode(rootpath,paramString);
	  saveAs(paramString, 0);
	  return paramString;
}
  
  public void saveAsPhysical(String paramString)
  	throws IOException, UploadException
  {
	  saveAs(paramString, 2);
  }

  protected void saveAs(String paramString, int paramInt)
    throws  IOException, UploadException
  {
...
System.out.println("SaveFile:"+str);
  ...
  {
	   return new ByteArrayInputStream(this.m_parent.m_binArray,this.m_startData,this.m_size);
  }
  ...
  public byte[] getBinaryData()
  {
	  ...
	  for (int i = 0; i < m_size; i++) {
		b[i]=this.m_parent.m_binArray[this.m_startData + i];
	} 
	  return b;
  }
